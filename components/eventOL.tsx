...
const EventCard: React.FC<EventCardProps> = ({
  ...
  return (
    <div className="lg:h-44 lg:w-64 w-40 h-40 m-2  [perspective:1000px]">
      <div
...
const EventList: React.FC<EventListProps> = ({ events }) => {
  return (
    <div className="lg:flex grid grid-cols-2 gap-4 justify-center items-center lg:gap-4 lg:min-h-fit lg:py-10">
